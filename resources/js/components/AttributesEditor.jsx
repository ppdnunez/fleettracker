...
export default function AttributesEditor({ rows, onChange }) {
    ...
    return (
        <div>
            ...
            <button onClick={addRow} style={{ width: '100%', padding: 9, borderRadius: 7, border: '1.5px solid #d97706', background: '#1a1a1a', color: '#d97706', fontSize: 13, fontWeight: 600, cursor: 'pointer' }}>
                + Add
            </button>
        </div>
    );
